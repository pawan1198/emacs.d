...
(fn &optional TEAM)" t)
(autoload 'slack-stop "slack" "\
Quit all slack teams." t)
...

;;; Generated autoloads from slack-activity-feed-buffer.el

(register-definition-prefixes "slack-activity-feed-buffer" '("activity-" "slack-"))
...
(register-definition-prefixes "slack-channel" '("slack-"))


;;; Generated autoloads from slack-company.el

(register-definition-prefixes "slack-company" '("company-slack-backend" "slack--"))
...

;;; Generated autoloads from slack-defcustoms.el

(register-definition-prefixes "slack-defcustoms" '("slack-"))
